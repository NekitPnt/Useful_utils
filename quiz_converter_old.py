...
def converter():
    ...
    converted_data = {"name": data["name"], "shuffle_answers": "0", "id": data["id"], "quiz_post_id": "",
                      ...
                      "activate_command": [data["name"].lower()],
                      "stata": {
                          "fields": [],
                          "periodic_fields": [],
                          "activator": "",
    ...
    for k, v in proxy_data.items():
        ...
        converted_data['questions'][k]['text'] = v['text']
    ...
    for res in data['result']:
        if res['title'] != '' and res['desc'] != '':
            converted_data['result'].append({'title': res['title'], 'attach': [], 'desc': res['desc']})
